...
//  DesignCodeIOS15
//
//  Created by Павел Курзо on 2.09.22.
//
...
struct BlobView: View {
    ...
    func path(in rect: CGRect, x: Double, x2: Double) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.6355*width*x2, y: height), control1: CGPoint(x: 0.92544*width*x2, y: 0.77749*height*x2), control2: CGPoint(x: 0.91864*width*x2, y: height))
        ...
        path.addCurve(to: CGPoint(x: 0.9923*width, y: 0.425934*height), control1: CGPoint(x: 0.67924*width, y: -0.10364*height*x), control2: CGPoint(x: 1.05906*width, y: 0.07436*height*x2))
        path.closeSubpath()
        return path
    }
}
...
struct BlobShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        let height = rect.size.height
        path.move(to: CGPoint(x: 0.9923*width, y: 0.42593*height))
        path.addCurve(to: CGPoint(x: 0.6355*width, y: height), control1: CGPoint(x: 0.92544*width, y: 0.77749*height), control2: CGPoint(x: 0.91864*width, y: height))
        ...
        path.addCurve(to: CGPoint(x: 0.9923*width, y: 0.425934*height), control1: CGPoint(x: 0.67924*width, y: -0.10364*height), control2: CGPoint(x: 1.05906*width, y: 0.07436*height))
        path.closeSubpath()
        return path
    }
}
